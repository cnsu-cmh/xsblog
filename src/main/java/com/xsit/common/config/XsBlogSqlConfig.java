...
@MapperScan(basePackages = "com.xsit.blog.mapper*")
public class XsBlogSqlConfig {
    ...
    public SqlSessionFactory xsBlogSqlSessionFactory(DataSource xsBlogDataSource) throws Exception {
        ...
        bean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:mapper/blog/*Mapper.xml"));
        bean.setTypeAliasesPackage("com.xsit.blog.entity");
