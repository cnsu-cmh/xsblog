package com.xsit.common.aspect;
...
public class LogAspect {
    ...
    @Pointcut("@annotation(com.xsit.common.annotation.SysLog)")
    public void webLog(){}
    ...
    public void doBefore(JoinPoint joinPoint) {
        ...
        SysLog mylog = method.getAnnotation(com.xsit.common.annotation.SysLog.class);
        if(mylog != null){
            //注解上的描述
