package com.xsit.admin.controller;
...
import com.xsit.common.exception.UserTypeAccountException;
import com.xsit.common.realm.AuthRealm;
...
public class LonginController {
    ...
    public String index(HttpSession session, @ModelAttribute(LOGIN_TYPE) String loginType) {
        ...
        if(LoginTypeEnum.ADMIN.name().equals(loginType)) {
            ...
            session.setAttribute("icon",StringUtils.isBlank(principal.getIcon()) ? "/static/comadmin/img/face.jpg" : principal.getIcon());
            return "admin/index";
        }else {
            return "index";
        }
