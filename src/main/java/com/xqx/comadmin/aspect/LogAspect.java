package com.xqx.comadmin.aspect;

import com.alibaba.fastjson.JSONObject;
import com.xqx.comadmin.annotation.SysLog;
import com.xqx.comadmin.config.MySysUser;
...
public class LogAspect {
    ...
    @Pointcut("@annotation(com.xqx.comadmin.annotation.SysLog)")
    public void webLog(){}
    ...
    public void doBefore(JoinPoint joinPoint) {
        ...
        SysLog mylog = method.getAnnotation(com.xqx.comadmin.annotation.SysLog.class);
        if(mylog != null){
            //注解上的描述
