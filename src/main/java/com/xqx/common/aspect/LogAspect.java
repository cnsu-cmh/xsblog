...
public class LogAspect {
    ...
    @Pointcut("@annotation(com.xqx.common.annotation.SysLog)")
    public void webLog(){}
    ...
    public void doBefore(JoinPoint joinPoint) {
        ...
        SysLog mylog = method.getAnnotation(com.xqx.common.annotation.SysLog.class);
        if(mylog != null){
            //注解上的描述
