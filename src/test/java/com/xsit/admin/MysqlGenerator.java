...
public class MysqlGenerator {
    ...
    private static String packageName="blog";    //文件路径
    private static String authorName="cusn-cmh";     //作者
    private static String[] table = {"blog_article","blog_tags","blog_channel"};             //table名字
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                ...
                new DataSourceConfig()
                        ...
                        .setUsername("root")
                        .setPassword("xqx1234")
                        .setUrl("jdbc:mysql://127.0.0.1:3306/xsblog?characterEncoding=utf8")
        ).setStrategy(
                // 策略配置
                new StrategyConfig()
                ...
                new PackageConfig()
                        //.setModuleName("User")
                        .setParent("com.xsit."+packageName)// 自定义包路径
                ...
                // 注入自定义配置，可以在 VM 中使用 cfg.xsblog 设置的值
                new InjectionConfig() {
                    @Override
                    public void initMap() {
                        Map<String, Object> map = new HashMap<>();
                        map.put("xsblog", this.getConfig().getGlobalConfig().getAuthor() + "-mp");
                        this.setMap(map);
                    }
       ...
       // System.err.println(mpg.getCfg().getMap().get("xsblog"));
    }
